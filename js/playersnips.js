$( document ).ready(function() {
    ...
    const inject_css= function(){
        ...
        var f = document.getElementsByTagName("script")[0];
            ...
            playerbs_css.href = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/css/kapow-playerbs.css";
           ...
           snipps_css.href = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/css/text.css";
   ...
   const inject_confetijs= function(){
    var f = document.getElementsByTagName("script")[0],
       ...
       j.src = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/js/player-confetti-cannon.js";
    ...
    const inject_fap= function(){
        ...
        var f = document.getElementsByTagName("script")[0];
            var playerbs_css = document.createElement("link");
            playerbs_css.rel = "stylesheet";
            playerbs_css.href = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@1.0.25/fap/css/all.min.css";
            f.parentNode.insertBefore(playerbs_css, f);
   ...
   const inject_bsjs= function(){
    ...
    const inject_typeform= function(){
        var f = document.getElementsByTagName("script")[0],
           ...
           j2.async = true;
           j2.src = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/js/playersnips-typeform.js";
    ...
    const inject_lottie= function(){
        var f = document.getElementsByTagName("script")[0],
           ...
           j2 = document.createElement("script");
           j2.async = true;
           j2.src = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/js/playersnips-lottie.js";
           f.parentNode.insertBefore(j2, f);
    }      
   ...
   const inject_sound= function(){
    var f = document.getElementsByTagName("script")[0],
       ...
       j.src = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/js/playersnips-sound.js";
    ...
    const inject_pspops= function(){
        var f = document.getElementsByTagName("script")[0],
           ...
           j.src = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/js/playersnips-popups.js";    
           f.parentNode.insertBefore(j, f);
    ...
    const inject_psevents= function(){
        var f = document.getElementsByTagName("script")[0],
           ...
           j.src = "https://cdn.jsdelivr.net/gh/robgalvinco/player-snippets@v1.0.25/js/playersnips-events.js";    
           f.parentNode.insertBefore(j, f);
